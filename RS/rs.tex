...
%\vspace*{0.1cm}
\begin{center}
{\LARGE \bf Commercial and Public Impact}\\
\vspace*{0.1cm}
...
%% of machine learning for scientific discovery. I belive my reserach on
%% reinforcement learning and black box opitmization
%}
